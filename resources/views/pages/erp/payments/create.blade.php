...
/* ─────────────────────────────────────────────
   ...
   Palette: Slate-900 text · Slate-50 bg · Indigo-700 primary
            Emerald-600 success · Amber-500 accent · Rose-600 danger
───────────────────────────────────────────── */
...
.ep-page { --ep-primary: #4338ca; --ep-primary-light: #eef2ff; --ep-primary-border: #c7d2fe;
           ...
           --ep-neutral: #64748b; --ep-text: #0f172a; --ep-text-muted: #64748b;
           --ep-bg: #f8fafc; --ep-card-bg: #ffffff;
           ...
           --ep-shadow-md: 0 4px 6px rgba(0,0,0,.07), 0 10px 30px rgba(0,0,0,.06); }
...
/* Cards */
.ep-card { background: var(--ep-card-bg); border-radius: var(--ep-radius); border: 1px solid var(--ep-border);
...
.ep-card-header-success  { background: rgba(5, 150, 105, 0.05); border-bottom: 1px solid rgba(5, 150, 105, 0.1); }
.ep-card-header-success .ep-card-icon { color: #059669 !important; }
.ep-card-title { font-size: 0.875rem; font-weight: 600; color: #334155; letter-spacing: 0.1px; margin: 0; }
.ep-card-title-white { color: #1e293b !important; }
.ep-card-icon { font-size: 0.9rem; }
.ep-card-badge { font-size: 0.65rem; font-weight: 700; padding: 2px 8px; border-radius: 20px;
                 background: rgba(255,255,255,0.2); color: #fff; letter-spacing: 0.5px; margin-left: auto; }
...
.ep-amount-card { border-radius: var(--ep-radius-sm); padding: 18px 14px; text-align: center;
                  border: 1px solid; transition: transform .2s; cursor: default; }
.ep-amount-card:hover { transform: translateY(-2px); }
.ep-amount-card .ep-ac-label { font-size: 0.69rem; font-weight: 700; text-transform: uppercase;
                                letter-spacing: 0.8px; margin-bottom: 10px; }
.ep-amount-card .ep-ac-value { font-size: 1.55rem; font-weight: 800; line-height: 1; margin-bottom: 4px;
                                letter-spacing: -0.5px; }
.ep-amount-card .ep-ac-cur   { font-size: 0.72rem; font-weight: 600; letter-spacing: 0.5px; }

.ep-ac-total  { background: rgba(67, 56, 202, 0.04); border: 1px solid rgba(67, 56, 202, 0.15); }
.ep-ac-total .ep-ac-label { color: #4338ca; }
.ep-ac-total .ep-ac-value { color: #312e81; }
.ep-ac-total .ep-ac-cur   { color: #6366f1; }

.ep-ac-paid   { background: rgba(5, 150, 105, 0.04); border: 1px solid rgba(5, 150, 105, 0.15); }
.ep-ac-paid .ep-ac-label  { color: #059669; }
.ep-ac-paid .ep-ac-value  { color: #064e3b; }
.ep-ac-paid .ep-ac-cur    { color: var(--ep-success); }

.ep-ac-due    { background: rgba(217, 119, 6, 0.04); border: 1px solid rgba(217, 119, 6, 0.2); }
.ep-ac-due .ep-ac-label   { color: #d97706; }
.ep-ac-due .ep-ac-value   { color: #78350f; }
.ep-ac-due .ep-ac-cur     { color: var(--ep-warning); }
...
.ep-form-input.is-invalid, .ep-form-select.is-invalid { border-color: #dc2626; }
.ep-form-input.is-invalid:focus { box-shadow: 0 0 0 3px rgba(220,38,38,.1); }
...
.ep-btn-success { background: #10b981; color: #fff; box-shadow: 0 1px 2px rgba(0,0,0,0.05); }
.ep-btn-success:hover { background: #059669; opacity: 0.95; transform: translateY(-1px); color: #fff; }
...
.ep-btn-lg { padding: 13px 24px; font-size: 0.95rem; }
...
.ep-alert-danger  { background: var(--ep-danger-light);  border: 1px solid var(--ep-danger-border);  color: #991b1b; }
...
/* SSLCommerz Button */
.ep-btn-ssl { background: #4f46e5; color: #fff; box-shadow: 0 1px 2px rgba(0,0,0,0.05); }
.ep-btn-ssl:hover { background: #4338ca; opacity: 0.95; transform: translateY(-1px); color: #fff; }
.ep-ssl-divider { display: flex; align-items: center; gap: 12px; margin: 20px 0; }
.ep-ssl-divider::before, .ep-ssl-divider::after { content: ''; flex: 1; height: 1px; background: var(--ep-border); }
.ep-ssl-divider span { font-size: 0.75rem; font-weight: 600; color: var(--ep-text-muted); text-transform: uppercase; letter-spacing: 0.8px; }

/* Sidebar – Booking ID Banner */
...
/* Sidebar stat row */
.ep-stat-row { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; margin-bottom: 4px; }
...
.ep-room-type { font-size: 0.68rem; font-weight: 700; padding: 2px 9px; border-radius: 20px;
                background: var(--ep-primary-light); color: #3730a3; letter-spacing: 0.3px; }
.ep-room-meta { font-size: 0.78rem; color: var(--ep-text-muted); margin-top: 6px; }
.ep-room-meta span { margin-right: 12px; }

/* Payment Rules */
.ep-rule { display: flex; align-items: flex-start; gap: 10px; padding: 10px 12px; border-radius: var(--ep-radius-sm); margin-bottom: 8px; }
.ep-rule:last-child { margin-bottom: 0; }
.ep-rule-icon { width: 22px; height: 22px; border-radius: 50%; display: flex; align-items: center; justify-content: center; flex-shrink: 0; font-size: 0.65rem; margin-top: 1px; }
.ep-rule-text { font-size: 0.8rem; color: #334155; margin: 0; line-height: 1.45; }
.ep-rule-text strong { color: var(--ep-text); }
.ep-rule-green  { background: #ecfdf5; } .ep-rule-green .ep-rule-icon  { background: #d1fae5; color: #065f46; }
.ep-rule-red    { background: #fef2f2; } .ep-rule-red .ep-rule-icon    { background: #fecaca; color: #991b1b; }
.ep-rule-blue   { background: #eff6ff; } .ep-rule-blue .ep-rule-icon   { background: #dbeafe; color: #1d4ed8; }
.ep-rule-amber  { background: #fffbeb; } .ep-rule-amber .ep-rule-icon  { background: #fde68a; color: #92400e; }
...
@if ($errors->any())
<div class="ep-alert ep-alert-danger mb-4" role="alert" style="position:relative;">
...
<div class="ep-page">
    ...
    <div class="ep-page-header d-flex justify-content-between align-items-center flex-wrap gap-3">
        <div>
            <h2>
                <i class="fas fa-file-invoice-dollar" style="color:#4338ca;"></i>
                Record Payment
            </h2>
    ...
    <div class="row g-4">
        ...
        <div class="col-lg-8">
            ...
            {{-- Payment Information --}}
            <div class="ep-card">
                <div class="ep-card-header ep-card-header-success">
                    <i class="fas fa-money-check-alt ep-card-icon" style="color:rgba(255,255,255,.85);"></i>
                    <h6 class="ep-card-title ep-card-title-white">Payment Information</h6>
                </div>
                <div class="ep-card-body">
                        ...
                        <form action="{{ route('payment.store', $booking) }}" method="POST">
                            ...
                            <div class="mb-4">
                                ...
                                <p class="ep-form-hint">
                                    ...
                                    Maximum payable: <strong>{{ number_format($dueAmount, 2) }} BDT</strong>
                                </p>
                            </div>
                            ...
                            <div class="row g-3 mb-4">
                                <div class="col-md-6">
                                    <label for="method" class="ep-form-label">
                                        Payment Method <span class="req">*</span>
                                    </label>
                                    <select id="method" name="method"
                                            class="ep-form-select @error('method') is-invalid @enderror" required>
                                    ...
                                    @error('method')
                                        <p class="ep-form-error">{{ $message }}</p>
                                    @enderror
                                </div>
                                <div class="col-md-6">
                                    <label for="type" class="ep-form-label">
                                        Payment Type <span class="req">*</span>
                                    </label>
                                    <select id="type" name="type"
                                            class="ep-form-select @error('type') is-invalid @enderror" required>
                            ...
                            {{-- Reference --}}
                            <div class="mb-5">
                                <label for="reference" class="ep-form-label">
                                    Transaction Reference / Cheque Number
                                    <span style="font-weight:400; color:var(--ep-text-muted);">(Optional)</span>
                                </label>
                                <input type="text" id="reference" name="reference"
                                       class="ep-form-input @error('reference') is-invalid @enderror"
                                       placeholder="e.g. TXN-20260404, CHQ-00123"
                                       value="{{ old('reference') }}">
                                @error('reference')
                                    <p class="ep-form-error">{{ $message }}</p>
                                @enderror
                                <p class="ep-form-hint">
                                    <i class="fas fa-tag" style="color:#4338ca;"></i>
                                    Provide reference number for audit trail purposes
                                </p>
                            </div>

                            {{-- Actions --}}
                            <div class="d-flex gap-2">
                                <button type="submit" class="ep-btn ep-btn-success ep-btn-xl flex-grow-1">
                                    <i class="fas fa-check-circle"></i> Record Payment
                                </button>
                                <a href="{{ route('booking.show', $booking) }}" class="ep-btn ep-btn-ghost ep-btn-xl">
                                    Cancel
                                </a>
                            </div>
                        </form>

                        <div class="ep-ssl-divider">
                            <span>Or Pay Online</span>
                        </div>

                        <a href="{{ route('payment.sslcommerz.checkout', $booking) }}"
                           class="ep-btn ep-btn-ssl ep-btn-xl ep-btn-full">
        ...
        <div class="col-lg-4">
            ...
            {{-- Payment Rules --}}
            <div class="ep-card" style="border-left:4px solid #dc2626;">
                <div class="ep-card-header" style="background:#fef2f2;">
                    <i class="fas fa-shield-alt ep-card-icon" style="color:#dc2626;"></i>
                    <h6 class="ep-card-title">Payment Policy</h6>
                </div>
                <div class="ep-card-body" style="padding:16px;">
                    <div class="ep-rule ep-rule-green">
                        <div class="ep-rule-icon"><i class="fas fa-check"></i></div>
                        <p class="ep-rule-text"><strong>50% advance</strong> required at check-in</p>
                    </div>
                    <div class="ep-rule ep-rule-red">
                        <div class="ep-rule-icon"><i class="fas fa-check"></i></div>
                        <p class="ep-rule-text"><strong>100% payment</strong> required at check-out</p>
                    </div>
                    <div class="ep-rule ep-rule-blue">
                        <div class="ep-rule-icon"><i class="fas fa-undo"></i></div>
                        <p class="ep-rule-text">Refunds available for <strong>paid</strong> transactions</p>
                    </div>
                    <div class="ep-rule ep-rule-amber">
                        <div class="ep-rule-icon"><i class="fas fa-file"></i></div>
                        <p class="ep-rule-text">Retain transaction <strong>reference</strong> for audit trail</p>
                    </div>
                </div>
            </div>
