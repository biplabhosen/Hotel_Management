            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <input type="text" name="room_number" class="form-control" value="{{ old('room_number') }}" placeholder=" " required>
                        <label>Room No *</label>
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <input type="number" name="capacity" value="{{old('capacity')}}" class="form-control" placeholder=" " required>
